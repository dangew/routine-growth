...
public abstract class BaseServiceTest {
    ...
    @Autowired
    protected RoutineCategoryService routineCategoryService;
    ...
    public void setUp() {
        ...
        routineCategoryResponseStudy = routineCategoryService.createRoutineCategory(
            RoutineCategoryRequest.builder().name(categories[0]).build());
        routineCategoryResponseExercise = routineCategoryService.createRoutineCategory(
